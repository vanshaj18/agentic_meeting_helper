    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-5 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Agent Prompt</label>
        ...
        <div className="p-4 md:p-5 border-t border-gray-200 sticky bottom-0 bg-white">
          <button
            onClick={onClose}
            className="w-full px-4 md:px-6 py-2 md:py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-sm md:text-base font-medium"
          >
            Close
          </button>
        </div>
