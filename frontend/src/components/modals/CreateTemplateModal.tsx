    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-6 space-y-4 md:space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-2">Meeting Context</label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-3">Add Agents</label>
            <div className="border border-gray-300 rounded-lg p-3 md:p-4 max-h-48 overflow-y-auto">
              {agents.length === 0 ? (
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-3">Add Documents</label>
            <div className="border border-gray-300 rounded-lg p-3 md:p-4 max-h-48 overflow-y-auto">
              {documents.length === 0 ? (
          ...
          <div>
            <label className="block text-sm font-medium text-gray-900 mb-3">Add Cue Cards</label>
            <div className="border border-gray-300 rounded-lg p-3 md:p-4 max-h-48 overflow-y-auto">
              {cueCards.length === 0 ? (
